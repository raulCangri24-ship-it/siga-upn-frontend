...
import { GraduationCap, BookOpen, Clock, Wallet, Monitor, LogOut, Bell, Sun, Moon } from 'lucide-react'
      ...
      <div style={{ display: 'flex', flex: 1, alignItems: 'stretch', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, padding: '36px 40px', overflowY: 'auto' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <h2 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0 }}>Mis servicios</h2>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '5px' }}>{item.titulo}</div>
